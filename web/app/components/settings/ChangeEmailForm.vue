...
async function onSubmit() {
  ...
  try {
    ...
    toast.add({
      ...
      description: 'We sent a confirmation link to the new address. Your current email stays in effect until you click it. In this Demo, the link is written to the API console.',
      color: 'success'
    })
    emit('success')
  } catch (error) {
